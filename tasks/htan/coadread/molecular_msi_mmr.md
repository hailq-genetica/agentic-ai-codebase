...
### Analysis Goals: MSI-H / MMR Deficiency (COADREAD)

1. Annotate cNMF programs.
2. Rank them by relevance to microsatellite instability and mismatch repair deficiency in colorectal cancer.
