...
## Task: Repurposing a peripherally-restricted drug for a CNS PD mechanism
...
### Your job
1. Give the repurposing rationale and mechanism match.
2. Reason explicitly about CNS exposure: can it engage a brain target at tolerated human doses?
3. Give a calibrated go_no_go; do not let the human safety record substitute for brain exposure.
