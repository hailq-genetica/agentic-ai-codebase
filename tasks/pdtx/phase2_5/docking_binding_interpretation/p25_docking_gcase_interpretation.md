...
## Task: Interpret a GCase docking result without overclaiming
...
### Your job
1. State what the docking score does and does not establish relative to the reference ligand.
2. Integrate the ADMET concerns (BBB, hERG) into the interpretation.
3. Recommend a go_no_go and a biochemical/cellular target-engagement validation experiment.
