...
## Task: ADMET review of a brain-penetrant LRRK2 inhibitor
...
### Your job
1. Interpret the CNS exposure and core ADMET profile.
2. Address the LRRK2 class peripheral on-target safety concern and a therapeutic-window strategy.
3. Give a calibrated go_no_go with the next safety experiment.
