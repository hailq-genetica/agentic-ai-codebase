...
## Task: ADMET review of a candidate for a peripheral PD-relevant target
...
### Your job
1. Decide whether low BBB penetration is a liability given that the target is peripheral.
2. Assess the rest of the ADMET/safety profile for chronic use.
3. Give a calibrated go_no_go; do not reflexively penalize low BBB when CNS exposure is not needed.
