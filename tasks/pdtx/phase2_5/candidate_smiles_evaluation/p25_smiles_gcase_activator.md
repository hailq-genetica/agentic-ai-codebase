...
## Task: Evaluate a non-inhibitory GCase activator candidate
...
### Your job
1. Contrast a non-inhibitory activator with an active-site pharmacological chaperone (and the inhibitory-chaperone paradox).
2. Assess CNS drug-likeness/BBB and the need to show increased lysosomal GCase activity in cells.
3. Give a calibrated go_no_go and a target-engagement next experiment.
