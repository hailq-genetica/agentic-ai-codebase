...
## Task: Candidate with strong docking but poor BBB and hERG liability
...
### Your job
1. Assess whether the docking score justifies progression on its own.
2. Weigh the poor predicted BBB penetration for a CNS target and the hERG liability.
3. Give a calibrated go_no_go decision and the next experiment if any.
