...
## Task: Claim check: urate-elevating inosine is neuroprotective in PD
...
2. Separate the epidemiological association and target engagement (urate elevation) from clinical benefit.
3. State the evidence level and the implication of the futility result.
