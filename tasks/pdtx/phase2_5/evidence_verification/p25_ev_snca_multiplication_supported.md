...
## Task: Claim check: SNCA multiplications cause autosomal-dominant PD
...
2. State the evidence level (human genetics) and the gene-dosage relationship.
3. State the main uncertainty (rarity; relationship to common sporadic PD).
