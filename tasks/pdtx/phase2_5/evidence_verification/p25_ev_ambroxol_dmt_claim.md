...
## Task: Claim check: ambroxol as a disease-modifying PD therapy
...
2. Summarize supporting and limiting evidence and state the highest evidence level reached.
3. State the main uncertainty and why the word 'proven' is or is not justified.
