...
## Task: Claim check: levodopa is proven to slow PD progression
...
2. Distinguish the strong symptomatic effect from an unproven disease-modifying effect, noting the discordant clinical vs imaging results.
3. State what would be needed to support a disease-modification claim.
